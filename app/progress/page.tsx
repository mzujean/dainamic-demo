...
const REMINDERS = [
  { icon: "⚠️", label: "Meta Access Token",   note: "Expires ~1hr. Refresh at developers.facebook.com/tools/explorer", urgent: true },
  ...
  return (
    <div style={{ maxWidth: 960, margin: "0 auto" }} className="fade-up">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginBottom: 20 }}>
        ...
        <StatCard label="Overall progress"  value={`${overallPct}%`} change={`${doneMilestones}/${totalMilestones} milestones`} trend="up" accent="var(--accent-green)" glow="green" />
      </div>
